...
import CampaignStep2 from './campaign-step2';
import CampaignStep3 from './campaign-step3';

const steps = [{title:'Campaign Details',component:<CampaignStep1/>},{title:'Audience & Influencers',component:<CampaignStep2/>},{title:'Upload Media',component:<CampaignStep3/>}];
